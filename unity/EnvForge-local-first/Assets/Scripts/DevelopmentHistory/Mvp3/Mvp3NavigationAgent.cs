...
namespace EnvForge.Mvp3
{
    ...
    public sealed class Mvp3NavigationAgent : Agent, INavigationEpisodeEvents
    {
        ...
        private readonly float[] observationBuffer = new float[Mvp3GoalObservation.ValueCount];

        private Transform goal;
        private Rigidbody agentBody;
        private AgentMotor motor;
        private NavigationMetrics navigationMetrics;
        private Mvp3GoalObservationProvider observationProvider;
        ...
        public void Configure(
            ...
            Mvp3GoalObservationProvider observations,
        ...
        public override void CollectObservations(VectorSensor sensor)
        {
            if (observationProvider == null ||
                !observationProvider.TryGetObservation(out Mvp3GoalObservation observation) ||
                !observation.TryWriteTo(observationBuffer))
            {
                for (int i = 0; i < Mvp3GoalObservation.ValueCount; i++)
                {
